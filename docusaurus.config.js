...
const config = {
  ...
  tagline: 'A comprehensive guide to embodied AI: ROS 2, Digital Twins, NVIDIA Isaac, and Vision-Language-Action Systems',
  ...
  // Add custom plugins for the RAG chatbot
  plugins: [
    // Plugin for the RAG chatbot widget
    async function myPlugin(context, options) {
      return {
        name: 'docusaurus-plugin-robotics-chatbot',
